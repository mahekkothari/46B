...
public class MissionOrganizer implements Iterable<Mission>
{
	...
	private Set<Mission> cheapMissions;
	private Set<Missions> expensiveMissions;
	
	public MissionOrganizer()
	{
		// Create the 2 mission collections.
		this.cheapMissions = new LinkedHashSet<>();
	...
	public Iterator<Mission> iterator()
	{
		...
		allMissions.addAll(cheapMissions);
